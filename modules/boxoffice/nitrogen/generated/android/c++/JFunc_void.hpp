...
namespace margelo::nitro::boxoffice {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/boxoffice/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/boxoffice/Func_void_cxx;";

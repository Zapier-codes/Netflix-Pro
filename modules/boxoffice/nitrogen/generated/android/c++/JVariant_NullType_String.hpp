...
namespace margelo::nitro::boxoffice {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/boxoffice/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/boxoffice/Variant_NullType_String$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/boxoffice/Variant_NullType_String$Second;";
